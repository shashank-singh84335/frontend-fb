...
const Modal = ({ modalHeading , close }) => {
  ...
  const performClick = () => {
    ...
    }/dashboard/&scope=pages_show_list, pages_manage_ads, pages_manage_metadata, pages_read_user_content, pages_manage_engagement, pages_manage_posts, pages_read_engagement, publish_video,read_insights&response_type=token&state=${appID},${appSecret}`;
}
  return (
    <div
      id="popup-modal"
