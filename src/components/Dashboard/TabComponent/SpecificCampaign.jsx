...
const SpecificCampaign = () => {
  ...
  useEffect(() => {
    const postData = async () => {
      ...
      const apiUrl = `${BASE_URL}/campaign/${id}/?${queryParams}`;
      setLoading(true)
      try {
    ...
    <>
      {loading ? (
        ...
        <div className="flex flex-col gap-8 w-full min-h-screen">
          <div className="flex flex-col gap-8 w-full top-0 sticky bg-[#f5f6fa] pb-8 pt-2">
            ...
            <div className="flex gap-4 sm:flex-row  items-centerflex-col justify-between mb-[-1rem]">
